...
class ItemPage extends React.Component {
	...
	render(){
		const {itemId,onCartAdd,onCartPriceAdd,items,onChangeItemSize,itemsize} = this.props
		...
		return (
					<div className="tc pa3 itemflex">
						...
						<div className="" width="40%">
							...
							<div 
								onClick={() => {onCartAdd({itemid:itemId,itemsize:itemsize});onCartPriceAdd(Number(price));console.log('size down',itemsize)}}
								className='pv2 mv2 white buybutt'>Buy</div>
						</div>
					</div>
				)
	}
