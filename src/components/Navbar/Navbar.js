...
const Navigation = ({
  ...
  return (
    <div
      className={route === "home" ? "shadow-1 menu-area" : "shadow-1 menu-area"}
    >
      <link
      ...
      <ul>
        <li>
          <div onClick={() => onRouteChange("home")} className="logo grow">
            Logo
          </div>
        </li>
        <li>
        ...
        <li>
          <div
            ...
            className="grow hover-bg-white-20"
          >
            Cart({cart.length})
          </div>
        </li>
        <li>
          {isSignedIn === false ? (
            <div onClick={() => onRouteChange("signin")} className="grow">
              Sign In
            </div>
          ) : user.isAdmin === false ? (
